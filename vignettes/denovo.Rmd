...
The heatmap indicates that `S1-S5` correspond to SBS3 (HRD), SBS2.13 (APOBEC), SBS1 (aging), 
SBS10 (POLE), and SBS6 (MMR), respectively. To faciliate further analyses, it is
convenient to re-label de novo signatures based on these annotations:
```{r lsap, eval = TRUE}
annotation <- c('SBS_1'='S3','SBS_2.13'='S2','SBS_3'='S1','SBS_6'='S5','SBS_10'='S4')
